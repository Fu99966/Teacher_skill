...
def _local_fallback_fields(
    *,
    ...
    base: dict[str, str] = {
        ...
        "teaching_environment": "标准多媒体教室，配备投影设备、白板或智慧黑板，网络畅通。如需实验或实训，应具备相应的操作台和演示器材。",
        "teaching_aids": "PPT课件、教材、学习任务单。如涉及实物展示或实验，准备对应的教具和演示材料。",
        "teaching_method": f"案例教学、任务驱动、小组讨论、实物演示相结合。通过生活案例导入《{title}》相关概念，再组织学生观察分析，最后以小组讨论完成应用场景分析。",
